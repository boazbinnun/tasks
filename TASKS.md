...
- [ ] **[Internal] Create Claude Presentation for Team** - Prepare and present a presentation on Claude to the team | added: 2026-03-29 | updated: 2026-03-29
  - [x] Presented to Yariv & Itay ✅
  - [ ] Showcase meeting still needed with Olivier

- [ ] **[Dinvest] Owner Portal Mockup — Fine-Tuning & Dev Handoff** - Mockup in final stages; work with Yariv to fine-tune and prepare for development phase | added: 2026-04-07 | updated: 2026-04-07
  - 🔗 Mockup: https://owner-portal-mockup.lovable.app/
  - 👤 Working with: Yariv
  - 🎯 Next step: review with Yariv → finalize → hand off to dev

- [ ] **[Dinvest M&A] Build M&A Process Management CRM** - A CRM app enabling external brokers and Dinvest management to manage acquisitions and mergers with other property management companies | added: 2026-04-07 | updated: 2026-04-14
...
- [ ] **[Dinvest] RobinReal.ai Demo** - Demo call scheduled with Sebastian Waszkis (CEO, robinreal.ai) to evaluate AI-driven rental lifecycle platform as potential fit for Dinvest | added: 2026-04-14 | updated: 2026-04-14
...
- [x] **[Dinvest] Open Linear Ticket for Idan — Migrate Owners Data from Zoho to Inhouse Hub** - Create Linear ticket for Idan to migrate all owner data from Zoho into the inhouse hub | done: 2026-04-14 | updated: 2026-04-14
  - 🔗 https://linear.app/idanc/issue/DIN-444/add-the-following-fields-to-the-owner-object-in-the-hub
...
- [ ] **[Onboarding App] New Employee Onboarding** → **Onboarding App** - Monitor onboarding setup for new employees in the new onboarding app | updated: 2026-04-14
  - 👤 **Ryan Gauci-Maistre** — Start: 2026-04-16
  - 👤 **Dominik Inguanta** — Start: 2026-05-01

- [x] **[Onboarding App] Include Direct Manager in Office 365 Admin Request** → **Onboarding App / Admir (IT)** - When the onboarding app sends a new Office 365 user request to Admir, also include the new employee's direct manager | done: 2026-03-29 | updated: 2026-03-29

- [x] **[Onboarding App] Job Title → Security Template Mapping** → **Onboarding App / Admir (IT)** - Add feature to map each job title to a Microsoft security template; when Admir receives a new employee request, the correct security template is shown automatically | done: 2026-03-29 | updated: 2026-03-29

- [x] **[Zoho] Holiday/Vacation Coverage** → **Idan** - Triage Agent & Call-to-Ticket vacation warning integration | done: 2026-03-29 | updated: 2026-03-29
- [x] **[Zoho] Phone Number Format** → **Idan** - Display phone numbers in Swiss format (+41 76 541 03 45) instead of raw format | raised by: Philipp | Linear ticket created: 2026-03-25 | done: 2026-03-30 | updated: 2026-03-30
- [x] **[Zoho] Ticket Creator Visibility** → **Idan** - Show actual ticket creator (Ali, Tobias, Triage Agent) instead of Idan; consider adding a new field | raised by: Olivier | Linear ticket created: 2026-03-25 | done: 2026-03-29 | updated: 2026-03-29
  - ✅ Deployed in Portal Release 2026-03-29: tickets now created on behalf of the original sender
- [ ] **[Power BI] Owner Dashboard KPI Fields** → **Idan** - Add 6 new Netto-based KPI fields + rename 2 existing ones + retire 6 old Brutto/Akonto cards | Linear ticket created: 2026-03-25 | updated: 2026-03-25
...
- [x] **[Zoho] Email Reply Thread** → **Idan** - Development task already planned; implement fix in email threading | raised by: Albert | done: 2026-03-30 | updated: 2026-03-30
- [ ] **[Dinvest Website] Remove Org Chart Section from About Us Page** → **Ilya (web developer)** - Remove the Org Chart section completely from the Dinvest About Us page | email sent: 2026-04-13 | updated: 2026-04-13
...
- [ ] **[Zoho] Ticket Routing Rules** → **Philipp → Olivier → Idan** - Philipp sends current routing rules to Olivier; Olivier reviews and forwards to Idan; Idan implements | raised by: Philipp | updated: 2026-04-14
- [x] **[Zoho] Phone Ticket Data Quality** → **Olivier** - Already addressed via Phone AI Processing training (same action) | raised by: Miriam | done: 2026-03-29 | updated: 2026-03-29
...
- [x] **[Zoho] Support Email Architecture (Reply-To Fix)** - Dedicated support@dinvest.ag mailbox connected to Zoho Desk, replacing info@dinvest.ag Reply-To that caused duplicate tickets via Triage Tool | raised by: Albert | done: 2026-03-30 | updated: 2026-03-30
...
- [x] **[Dinvest] Reporting Walkthrough with Ruslan & David** - Walked through Power BI + WW Portal live with Ruslan Marakhovskii & David Gast (NY) | introduced by: Yariv | done: 2026-04-14 | updated: 2026-04-14
  - 📧 Ruslan Marakhovskii (David's accountant) | 👤 David Gast (portfolio owner, NY)

- [x] **[Dinvest] Design Mockup for Tenant App (imofix replacement)** - Working mockup + full product documentation built. Replaces Zoho checklists for move-outs and building onboarding. Live at: https://dinvest-portal.vercel.app | done: 2026-04-06 | updated: 2026-04-06

- [x] **[Dinvest] Open Linear Ticket for Idan — Tenant App** - Linear ticket opened with PRDs, Excel task lists, and all supporting files for the new checklist system (move-out + building onboarding) | done: 2026-04-06 | updated: 2026-04-06

- [x] ~~**[Zoho] Phone AI Processing (Swiss German)**~~ - Both Ali and Tobias confirmed guidance received and understood | done: 2026-03-25 | updated: 2026-03-25
- [x] **[Linear] Write Ticket to Idan** - Linear ticket created for Zoho Desk UI fixes (phone format + ticket creator visibility) | done: 2026-03-25 | updated: 2026-03-25
- [x] **[Zoho] Team View for Philipp** - Created filtered view in Zoho Desk for Philipp's team | raised by: Philipp | done: 2026-03-25 | updated: 2026-03-25
  - 🔗 https://desk.zoho.com/agent/dinvestbewirtschaftung/support/tickets/list/stweg-offen?view=table
  - 📧 Email sent to Philipp
- [x] **[Zoho] Client Notifications** - Disable ALL automated emails to customers until system is stabilized | raised by: Albert | done: 2026-03-25 | updated: 2026-03-25
- [x] **[Zoho] Add Philipp Huber & Daniela Seitz to Zoho Project** - Implemented both users in Zoho | done: 2026-03-25 | updated: 2026-03-25
- [x] **[Zoho] Email Signature** - Configure signatures in Zoho Desk and send setup instructions to the team | raised by: Albert | done: 2026-03-25 | updated: 2026-03-25
- [x] **[Zoho] STWEG Owner Portal Welcome Template** - Update welcome letter template in Zoho with revised bullet point about document upload timing | requested by: Philipp | done: 2026-03-25 | updated: 2026-03-25
