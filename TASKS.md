...
- [ ] **[Zoho] Holiday/Vacation Coverage** → **Idan** - Triage Agent & Call-to-Ticket vacation warning integration | raised by: Albert | Linear ticket + technical spec sent to Idan: 2026-03-25
  - ✅ Researched Clockodo API, built vacation dashboard POC, wrote technical spec for Idan
...
- [ ] **[Zoho] Ticket Creator Visibility** → **Idan** - Show actual ticket creator (Ali, Tobias, Triage Agent) instead of Idan; consider adding a new field | raised by: Olivier | Linear ticket created: 2026-03-25
...
- [ ] **[Zoho] Phone AI Processing (Swiss German)** → **Olivier** - Train Ali and Tobias to NOT auto-create tickets from Call-to-Ticket; review AI recommendations first and fix before submitting | raised by: Albert
  - 📧 Guidance email sent to Ali & Tobias (EN + DE) | sent: 2026-03-25
  - ✅ Ali confirmed: "understood" | replied: 2026-03-25
  - ⏳ Awaiting confirmation from Tobias
- [ ] **[Zoho] Phone Ticket Data Quality** → **Olivier** - Already addressed via Phone AI Processing training (same action) | raised by: Miriam
...
- [ ] **[Zoho] Support Email Architecture** - Proposed switching to support@dinvest.ag as dedicated Zoho Desk mailbox; awaiting Idan's approval | since: 2026-03-25 | raised by: Albert
  - 📧 Email sent to Idan with full proposal (support@dinvest.ag as main channel, keep info@dinvest.ag for Triage Tool)
